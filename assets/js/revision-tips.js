...
!(function (d) {
  ...
  function setEventListeners() {
      var next = d.getElementsByClassName('carousel__button--next')[0], prev = d.getElementsByClassName('carousel__button--prev')[0];
  ...
  function moveCarouselTo(slide) {
      ...
      if (!moving) {
          ...
          var newPrevious = slide - 1, newNext = slide + 1, oldPrevious = slide - 2, oldNext = slide + 2;
